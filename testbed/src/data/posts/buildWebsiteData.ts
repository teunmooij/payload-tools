export function buildWebsiteData(authorId: string, categoryId: string, imageId: string) {
  return {
    title: 'Building a Professionally Designed Website with NextJS & TypeScript - Ep. 1',
    author: authorId,
    ...
    meta: {
      title: 'Payload CMS - Building a Professionally Designed Website with NextJS & TypeScript - Ep. 1',
      description:
